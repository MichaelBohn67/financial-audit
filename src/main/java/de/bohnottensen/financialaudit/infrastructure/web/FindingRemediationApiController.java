...
@RestController @RequestMapping("/api/findings") public class FindingRemediationApiController {
 ...
 @PatchMapping("/{id}/remediation/plan") @PreAuthorize("hasAnyRole('AUDITOR','LEAD_AUDITOR','ADMIN')") public Finding updatePlan(@PathVariable Long id,@RequestBody Plan r,@AuthenticationPrincipal UserDetails u){return service.updatePlan(id,r.plan(),u.getUsername());}
